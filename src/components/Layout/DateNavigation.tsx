...
export const DateNavigation = memo(
  ({ date, handleDateChange, isLoading }: ExtendedProps) => {
    return (
      <div className="overflow-hidden w-full backdrop-blur-xl bg-white/20 rounded-xl p-4 md:pl-4 md:p-2 flex items-center justify-center md:justify-between border border-white/30">
        {/* 왼쪽 화살표 */}
        ...
        {/* API URL & 버튼들 */}
        <div className="hidden md:flex items-center overflow-hidden py-2 px-4 rounded-xl border border-white/30 gap-4">
